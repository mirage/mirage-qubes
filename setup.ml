...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1ed86bf0f70ff1fa0ef1141df7a0ac89) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["RExec"; "GUI"; "DB"; "Msg_chan"; "S"];
                      lib_pack = true;
                      lib_internal_modules = ["Utils"; "Formats"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-qubes";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\214\212\129c\200\148(\156\197k\0148\213c.\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
